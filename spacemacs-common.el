...
(defun create-spacemacs-theme (variant theme-name)
  (dyn-let
   ((class '((class color) (min-colors 89))) ;;              ~~ Dark ~~                              ~~ Light ~~
    ...
    (head1         (if (eq variant 'dark) (if (true-color-p) "#2db9ff" "DeepSkyBlue1")    (if (true-color-p) "#094563" "DodgerBlue4")))
    (head1-bg      (if (eq variant 'dark) (if (true-color-p) "#293239" "gray17")          (if (true-color-p) "#f8f8f2" "gray97")))
    (head2         (if (eq variant 'dark) (if (true-color-p) "#00a6fb" "DeepSkyBlue2")    (if (true-color-p) "#0075af" "DodgerBlue3")))
    (head2-bg      (if (eq variant 'dark) (if (true-color-p) "#293235" "gray18")          (if (true-color-p) "#f8f8f2" "gray97")))
    (head3         (if (eq variant 'dark) (if (true-color-p) "#0487c9" "DeepSkyBlue3")    (if (true-color-p) "#0487c9" "DeepSkyBlue3")))
    (head3-bg      (if (eq variant 'dark) (if (true-color-p) "#293235" "gray19")          (if (true-color-p) "#f8f8f2" "gray97")))
    (head4         (if (eq variant 'dark) (if (true-color-p) "#0075af" "DodgerBlue3")     (if (true-color-p) "#00a6fb" "DeepSkyBlue2")))
    (head4-bg      (if (eq variant 'dark) (if (true-color-p) "#32322c" "gray20")          (if (true-color-p) "#f8f8f2" "gray97")))
    (head5         (if (eq variant 'dark) (if (true-color-p) "#094563" "DodgerBlue4")     (if (true-color-p) "#2db9ff" "DeepSkyBlue1")))
   ...
   (custom-theme-set-faces
    ...
    `(mu4e-cited-5-face ((,class (:foreground ,head5))))
    `(mu4e-cited-6-face ((,class (:foreground ,head2))))
    `(mu4e-cited-7-face ((,class (:foreground ,head2))))
