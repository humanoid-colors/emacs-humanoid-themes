...
;;;;; colors
    ...
    (red           (if (eq variant 'dark) (if (true-color-p) "#d60324" "red2")            (if (true-color-p) "#b8021f" "firebrick3")))
    ...
    (yellow        (if (eq variant 'dark) (if (true-color-p) "#ffb627" "goldenrod1")      (if (true-color-p) "#fb6107" "DarkOrange2")))
    ...
    (blue          (if (eq variant 'dark) (if (true-color-p) "#00a6fb" "DeepSkyBlue2")    (if (true-color-p) "#0487c9" "DeepSkyBlue3")))
    ...
    (aqua          (if (eq variant 'dark) (if (true-color-p) "#007fbf" "DeepSkyBlue4")    (if (true-color-p) "#008e8e" "cyan4")))
    (aqua-bg       (if (eq variant 'dark) (if (true-color-p) "#061413" "SteelBlue4")      (if (true-color-p) "#ebf9f9" "azure1")))
    (cyan          (if (eq variant 'dark) (if (true-color-p) "#09b7b7" "cyan3")           (if (true-color-p) "#004e64" "DeepSkyBlue4")))
...
;;;;; generic
    ...
    (comp          (if (eq variant 'dark) (if (true-color-p) "#ff9505" "DarkOrange")      (if (true-color-p) "#ff9505" "DarkOrange")))
    (err           (if (eq variant 'dark) (if (true-color-p) "#d60324" "red2")            (if (true-color-p) "#b8021f" "firebrick3")))
    ...
    (keyword       (if (eq variant 'dark) (if (true-color-p) "#0487c9" "DeepSkyBlue3")    (if (true-color-p) "#00a6fb" "DeepSkyBlue2")))
    ...
    (var           (if (eq variant 'dark) (if (true-color-p) "#00a6fb" "DeepSkyBlue2")    (if (true-color-p) "#0487c9" "DeepSkyBlue3")))
    (war           (if (eq variant 'dark) (if (true-color-p) "#ffb627" "goldenrod1")      (if (true-color-p) "#fb6107" "DarkOrange2"))))
