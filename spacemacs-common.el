...
(defun create-spacemacs-theme (variant theme-name)
  (dyn-let ((class '((class color) (min-colors 89))) ;;              ~~ Dark ~~                              ~~ Light ~~
        ...
        (base-dim      (if (eq variant 'dark) (if (true-color-p) "#686868" "#585858") (if (true-color-p) "#3b4045" "#afafd7")))
        (bg1           (if (eq variant 'dark) (if (true-color-p) "#232629" "#000000") (if (true-color-p) "#f8f8f2" "#ffffff")))
        (bg2           (if (eq variant 'dark) (if (true-color-p) "#292c30" "#1c1c1c") (if (true-color-p) "#efeae9" "#e4e4e4")))
        (bg3           (if (eq variant 'dark) (if (true-color-p) "#31363b" "#121212") (if (true-color-p) "#e3dedd" "#d0d0d0")))
        (bg4           (if (eq variant 'dark) (if (true-color-p) "#3b4045" "#080808") (if (true-color-p) "#d6d7d9" "#bcbcbc")))
        ...
        (comp          (if (eq variant 'dark) (if (true-color-p) "#28def0" "#d75fd7") (if (true-color-p) "#00cccc" "#8700af")))
        ...
        (head3         (if (eq variant 'dark) (if (true-color-p) "#F92672" "#67b11d") (if (true-color-p) "#F92672" "#5faf00")))
        ...
        (highlight     (if (eq variant 'dark) (if (true-color-p) "#49483E" "#444444") (if (true-color-p) "#D3FBF6" "#d7d7ff")))
        (highlight-dim (if (eq variant 'dark) (if (true-color-p) "#3b4045" "#444444") (if (true-color-p) "#CAF5FD" "#d7d7ff")))
        ...
        (str           (if (eq variant 'dark) (if (true-color-p) "#74BDCD" "#2aa198") (if (true-color-p) "#AE81FF" "#2aa198")))
        ...
        (ttip-bg       (if (eq variant 'dark) (if (true-color-p) "#3b4045" "#444444") (if (true-color-p) "#e3dedd" "#dfdfff")))
        ...
        ;; colors
        (aqua          (if (eq variant 'dark) (if (true-color-p) "#74DBCD" "#2aa198") (if (true-color-p) "#74DBCD" "#2aa198")))
...
;;;;; display-line-numbers-mode (Emacs 26+)
     (when (>= emacs-major-version 26)
       ...
       `(line-number-current-line ((,class (:foreground ,base-dim :background ,bg2)))))
...
;;;;; mu4e
     ...
     `(mu4e-unread-face ((,class (:foreground ,red :inherit bold))))
