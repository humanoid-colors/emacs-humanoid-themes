...
(defun create-spacemacs-theme (variant theme-name)
  (dyn-let
   ((class '((class color) (min-colors 89))) ;;              ~~ Dark ~~                              ~~ Light ~~
    ...
    (red-bg-s      (if (eq variant 'dark) (if (true-color-p) "#512e31" "red4")            (if (true-color-p) "#f5bbc5" "pink")))
    (red-fg        (if (eq variant 'dark) (if (true-color-p) "#f5bbc5" "pink")            (if (true-color-p) "#512e31" "red4")))
    ...
    (mat           (if (eq variant 'dark) (if (true-color-p) "#a8c89b" "DarkSeaGreen3")   (if (true-color-p) "#29422d" "DarkOliveGreen")))
    (meta          (if (eq variant 'dark) (if (true-color-p) "#a0d2f3" "LightSkyBlue")    (if (true-color-p) "#2d4252" "DodgerBlue4")))
