...
(defun create-spacemacs-theme (variant theme-name)
  (dyn-let
   ((class '((class color) (min-colors 89))) ;;              ~~ Dark ~~                              ~~ Light ~~
    ...
    (red           (if (eq variant 'dark) (if (true-color-p) "#eb0028" "red2")            (if (true-color-p) "#b80c09" "firebrick3")))
    (red-bg        (if (eq variant 'dark) (if (true-color-p) "#3c2a2c" "firebrick4")      (if (true-color-p) "#faede4" "MistyRose")))
    (red-bg-s      (if (eq variant 'dark) (if (true-color-p) "#512e31" "red4")            (if (true-color-p) "#f45a74" "HotPink2")))
    (red-fg        (if (eq variant 'dark) (if (true-color-p) "#f45a74" "HotPink2")            (if (true-color-p) "#512e31" "red4")))
    (red-fg-s      (if (eq variant 'dark) (if (true-color-p) "#faede4" "MistyRose")       (if (true-color-p) "#3c2a2c" "firebrick4")))
    (green         (if (eq variant 'dark) (if (true-color-p) "#20bf55" "MediumSeaGreen")  (if (true-color-p) "#22a54e" "SpringGreen4")))
    (green-bg      (if (eq variant 'dark) (if (true-color-p) "#293235" "DarkSlateGray")   (if (true-color-p) "#edf2e9" "honeydew")))
    (green-bg-s    (if (eq variant 'dark) (if (true-color-p) "#29422d" "DarkOliveGreen")  (if (true-color-p) "#5ef28f" "SeaGreen3")))
    (green-fg      (if (eq variant 'dark) (if (true-color-p) "#5ef28f" "SeaGreen2")       (if (true-color-p) "#29422d" "DarkOliveGreen")))
    (green-fg-s    (if (eq variant 'dark) (if (true-color-p) "#edf2e9" "honeydew")        (if (true-color-p) "#293235" "DarkSlateGray")))
    (yellow        (if (eq variant 'dark) (if (true-color-p) "#fec31d" "goldenrod1")      (if (true-color-p) "#fb6107" "DarkOrange2")))
    ...
    (blue-bg       (if (eq variant 'dark) (if (true-color-p) "#293239" "RoyalBlue4")      (if (true-color-p) "#edf1fb" "LightBlue")))
    (blue-bg-s     (if (eq variant 'dark) (if (true-color-p) "#2d4252" "DodgerBlue4")     (if (true-color-p) "#72ccf9" "LightSkyBlue")))
    (blue-fg       (if (eq variant 'dark) (if (true-color-p) "#72ccf9" "LightSkyBlue")    (if (true-color-p) "#2d4252" "DodgerBlue4")))
    ...
    (cursor        (if (eq variant 'dark) (if (true-color-p) "#11d116" "green3")          (if (true-color-p) "#11d116" "green3")))
    ...
    (comp          (if (eq variant 'dark) (if (true-color-p) "#eb0028" "red2")            (if (true-color-p) "#b80c09" "firebrick3")))
    (err           (if (eq variant 'dark) (if (true-color-p) "#b80c09" "firebrick3")      (if (true-color-p) "#eb0028" "red2")))
    (func          (if (eq variant 'dark) (if (true-color-p) "#09b7b7" "cyan3")           (if (true-color-p) "#008e8e" "cyan4")))
    (head1         (if (eq variant 'dark) (if (true-color-p) "#20bf55" "MediumSeaGreen")  (if (true-color-p) "#22a54e" "SpringGreen4")))
    (head1-bg      (if (eq variant 'dark) (if (true-color-p) "#293239" "gray17")          (if (true-color-p) "#f8f8f2" "gray97")))
    (head2         (if (eq variant 'dark) (if (true-color-p) "#00a6fb" "DeepSkyBlue2")    (if (true-color-p) "#0487c9" "DodgerBlue2")))
    (head2-bg      (if (eq variant 'dark) (if (true-color-p) "#293235" "gray18")          (if (true-color-p) "#f8f8f2" "gray97")))
    (head3         (if (eq variant 'dark) (if (true-color-p) "#fb6107" "DarkOrange2")     (if (true-color-p) "#ff9505" "DarkOrange")))
    (head3-bg      (if (eq variant 'dark) (if (true-color-p) "#293235" "gray19")          (if (true-color-p) "#f8f8f2" "gray97")))
    (head4         (if (eq variant 'dark) (if (true-color-p) "#ff9505" "DarkOrange")      (if (true-color-p) "#fb6107" "DarkOrange2")))
    ...
    (keyword       (if (eq variant 'dark) (if (true-color-p) "#0487c9" "DodgerBlue2")     (if (true-color-p) "#00a6fb" "DeepSkyBlue2")))
    (lnum          (if (eq variant 'dark) (if (true-color-p) "#44505c" "gray29")          (if (true-color-p) "#abb2bf" "gray71")))
    (mat           (if (eq variant 'dark) (if (true-color-p) "#5ef28f" "DarkSeaGreen3")   (if (true-color-p) "#29422d" "DarkOliveGreen")))
    (meta          (if (eq variant 'dark) (if (true-color-p) "#72ccf9" "LightSkyBlue")    (if (true-color-p) "#2d4252" "DodgerBlue4")))
    (str           (if (eq variant 'dark) (if (true-color-p) "#20bf55" "MediumSeaGreen")  (if (true-color-p) "#22a54e" "SpringGreen4")))
    (suc           (if (eq variant 'dark) (if (true-color-p) "#008e8e" "cyan4")           (if (true-color-p) "#09b7b7" "cyan3")))
    ...
    (war           (if (eq variant 'dark) (if (true-color-p) "#fec31d" "goldenrod1")      (if (true-color-p) "#fb6107" "DarkOrange2"))))
   ...
   (custom-theme-set-faces
    ...
    `(link-visited ((,class (:foreground ,var :underline t))))
    ...
    `(magit-diff-added-highlight ((,class (:background ,green-bg :foreground ,green-fg))))
    `(magit-diff-removed-highlight ((,class (:background ,red-bg :foreground ,red-fg))))
    ...
    `(mu4e-flagged-face ((,class (:foreground ,const :inherit bold))))
    ...
    `(mu4e-highlight-face ((,class (:foreground ,war))))
    `(mu4e-title-face ((,class (:foreground ,head2 :inherit bold))))
    `(mu4e-replied-face ((,class (:foreground ,green-fg :background ,green-bg))))
