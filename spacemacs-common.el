...
;;;;; generic
    ...
    (comp          (if (eq variant 'dark) (if (true-color-p) "#26c6da" "cyan3")           (if (true-color-p) "#005005" "cyan4")))
    ...
    (func          (if (eq variant 'dark) (if (true-color-p) "#ff3d00" "DeepSkyBlue2")    (if (true-color-p) "#0069c0" "DeepSkyBlue3")))
    (head1         (if (eq variant 'dark) (if (true-color-p) "#2979ff" "DeepSkyBlue1")    (if (true-color-p) "#2376ad" "DodgerBlue4")))
    (head1-bg      (if (eq variant 'dark) (if (true-color-p) "#293239" "gray17")          (if (true-color-p) "#f8f8f2" "gray97")))
    (head2         (if (eq variant 'dark) (if (true-color-p) "#448aff" "DeepSkyBlue2")    (if (true-color-p) "#2b6590" "DodgerBlue3")))
    (head2-bg      (if (eq variant 'dark) (if (true-color-p) "#293235" "gray18")          (if (true-color-p) "#f8f8f2" "gray97")))
    (head3         (if (eq variant 'dark) (if (true-color-p) "#63a4ff" "DeepSkyBlue3")    (if (true-color-p) "#2d5475" "DeepSkyBlue3")))
    (head3-bg      (if (eq variant 'dark) (if (true-color-p) "#293235" "gray19")          (if (true-color-p) "#f8f8f2" "gray97")))
    (head4         (if (eq variant 'dark) (if (true-color-p) "#6ec6ff" "DodgerBlue3")     (if (true-color-p) "#2c445b" "DeepSkyBlue2")))
    (head4-bg      (if (eq variant 'dark) (if (true-color-p) "#32322c" "gray20")          (if (true-color-p) "#f8f8f2" "gray97")))
    (head5         (if (eq variant 'dark) (if (true-color-p) "#9be7ff" "DodgerBlue4")     (if (true-color-p) "#293542" "DeepSkyBlue1")))
    ...
    (keyword       (if (eq variant 'dark) (if (true-color-p) "#81d4fa" "DeepSkyBlue3")    (if (true-color-p) "#4527a0" "DeepSkyBlue2")))
    ...
    (meta          (if (eq variant 'dark) (if (true-color-p) "#7ecb20" "LightSkyBlue1")   (if (true-color-p) "#0d47a1" "DodgerBlue4")))
    (str           (if (eq variant 'dark) (if (true-color-p) "#03a9f4" "DarkOrange")      (if (true-color-p) "#ff3d00" "DarkOrange")))
    (suc           (if (eq variant 'dark) (if (true-color-p) "#4caf50" "green3")          (if (true-color-p) "#388e3c" "SpringGreen4")))
    ...
    (var           (if (eq variant 'dark) (if (true-color-p) "#ff9100" "turquoise2")      (if (true-color-p) "#5a9216" "DeepSkyBlue4")))
    (war           (if (eq variant 'dark) (if (true-color-p) "#e91e63" "goldenrod1")      (if (true-color-p) "#880e4f" "DarkOrange2"))))
