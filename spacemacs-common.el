...
(defun create-spacemacs-theme (variant theme-name)
  (dyn-let
   ((class '((class color) (min-colors 89))) ;;              ~~ Dark ~~                              ~~ Light ~~
    ...
    (green         (if (eq variant 'dark) (if (true-color-p) "#20bf55" "green3")          (if (true-color-p) "#22a54e" "SpringGreen4")))
    ...
    (cursor        (if (eq variant 'dark) (if (true-color-p) "#11d116" "LimeGreen")       (if (true-color-p) "#11d116" "LimeGreen")))
    ...
    (head1         (if (eq variant 'dark) (if (true-color-p) "#02d849" "LimeGreen")       (if (true-color-p) "#096b38" "DarkGreen")))
    (head1-bg      (if (eq variant 'dark) (if (true-color-p) "#293239" "gray17")          (if (true-color-p) "#f8f8f2" "gray97")))
    (head2         (if (eq variant 'dark) (if (true-color-p) "#20bf55" "green3")          (if (true-color-p) "#22a54e" "SpringGreen4")))
    (head2-bg      (if (eq variant 'dark) (if (true-color-p) "#293235" "gray18")          (if (true-color-p) "#f8f8f2" "gray97")))
    (head3         (if (eq variant 'dark) (if (true-color-p) "#22a54e" "SpringGreen4")    (if (true-color-p) "#20bf55" "green3")))
    (head3-bg      (if (eq variant 'dark) (if (true-color-p) "#293235" "gray19")          (if (true-color-p) "#f8f8f2" "gray97")))
    (head4         (if (eq variant 'dark) (if (true-color-p) "#096b38" "DarkGreen")       (if (true-color-p) "#02d849" "green2")))
    ...
    (mat           (if (eq variant 'dark) (if (true-color-p) "#5ef28f" "SeaGreen2")       (if (true-color-p) "#29422d" "DarkOliveGreen")))
    (meta          (if (eq variant 'dark) (if (true-color-p) "#72ccf9" "LightSkyBlue")    (if (true-color-p) "#2d4252" "DodgerBlue4")))
    (str           (if (eq variant 'dark) (if (true-color-p) "#20bf55" "green3")          (if (true-color-p) "#22a54e" "SpringGreen4")))
