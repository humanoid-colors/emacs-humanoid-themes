...
(defun create-spacemacs-theme (variant theme-name)
  (dyn-let ((class '((class color) (min-colors 89))) ;;              ~~ Dark ~~                              ~~ Light ~~
        ...
        (const         (if (eq variant 'dark) (if (true-color-p) "#AE81FF" "#d75fd7") (if (true-color-p) "#AE81FF" "#8700af")))
        (comment       (if (eq variant 'dark) (if (true-color-p) "#74777E" "#008787") (if (true-color-p) "#a49da5" "#008787")))
        (comment-light (if (eq variant 'dark) (if (true-color-p) "#797B7F" "#008787") (if (true-color-p) "#a49da5" "#008787")))
        (comment-bg    (if (eq variant 'dark) (if (true-color-p) "#232629" "#000000") (if (true-color-p) "#f8f8f2" "#ffffff")))
        (comp          (if (eq variant 'dark) (if (true-color-p) "#28def0" "#d75fd7") (if (true-color-p) "#16b1fb" "#8700af")))
        (err           (if (eq variant 'dark) (if (true-color-p) "#e0211d" "#e0211d") (if (true-color-p) "#e0211d" "#e0211d")))
        (func          (if (eq variant 'dark) (if (true-color-p) "#FA518D" "#d75fd7") (if (true-color-p) "#259b24" "#8700af")))
        (head1         (if (eq variant 'dark) (if (true-color-p) "#11d116" "#268bd2") (if (true-color-p) "#259b24" "#268bd2")))
        ...
        (head3         (if (eq variant 'dark) (if (true-color-p) "#f67400" "#67b11d") (if (true-color-p) "#f67400" "#5faf00")))
        (head3-bg      (if (eq variant 'dark) (if (true-color-p) "#293235" "#262626") (if (true-color-p) "#f8f8f2" "#ffffff")))
        (head4         (if (eq variant 'dark) (if (true-color-p) "#ffc600" "#875f00") (if (true-color-p) "#ffc600" "#875f00")))
        ...
        (mat           (if (eq variant 'dark) (if (true-color-p) "#86C30D" "#86dc2f") (if (true-color-p) "#86C30D" "#af005f")))
        (meta          (if (eq variant 'dark) (if (true-color-p) "#f67400" "#af875f") (if (true-color-p) "#f67400" "#df5f5f")))
        (str           (if (eq variant 'dark) (if (true-color-p) "#10DBBC" "#2aa198") (if (true-color-p) "#282c34" "#2aa198")))
        (suc           (if (eq variant 'dark) (if (true-color-p) "#86C30D" "#86dc2f") (if (true-color-p) "#42ae2c" "#00af00")))
        ...
        (type          (if (eq variant 'dark) (if (true-color-p) "#D47402" "#df005f") (if (true-color-p) "#D47402" "#af005f")))
        (var           (if (eq variant 'dark) (if (true-color-p) "#AE81FF" "#8787d7") (if (true-color-p) "#00cccc" "#af5fd7")))
        (war           (if (eq variant 'dark) (if (true-color-p) "#f67400" "#f67400") (if (true-color-p) "#f67400" "#f67400")))
        ...
        (green         (if (eq variant 'dark) (if (true-color-p) "#11d116" "#67b11d") (if (true-color-p) "#259b24" "#5faf00")))
        ...
        (cyan          (if (eq variant 'dark) (if (true-color-p) "#28def0" "#00ffff") (if (true-color-p) "#00cccc" "#008080")))
        (red           (if (eq variant 'dark) (if (true-color-p) "#ed1515" "#d70000") (if (true-color-p) "#ed1515" "#d70008")))
        ...
        (magenta       (if (eq variant 'dark) (if (true-color-p) "#AE81FF" "#af00df") (if (true-color-p) "#AE81FF" "#800080")))
        (yellow        (if (eq variant 'dark) (if (true-color-p) "#ffc600" "#875f00") (if (true-color-p) "#ffc600" "#875f00")))
        (yellow-bg     (if (eq variant 'dark) (if (true-color-p) "#32322c" "#262626") (if (true-color-p) "#f6f1e0" "#ffffff")))
        (orange        (if (eq variant 'dark) (if (true-color-p) "#f67400" "#f67400") (if (true-color-p) "#f67400" "#f67400")))
        )
