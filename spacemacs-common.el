...
;;;;; colors
    ...
    (yellow        (if (eq variant 'dark) (if (true-color-p) "#ffc107" "goldenrod1")      (if (true-color-p) "#ff8f00" "DarkOrange2")))
    (yellow-bg     (if (eq variant 'dark) (if (true-color-p) "#32322c" "sienna4")         (if (true-color-p) "#f6f1e0" "linen")))
    (orange        (if (eq variant 'dark) (if (true-color-p) "#ff9800" "DarkOrange")      (if (true-color-p) "#ff5722" "DarkOrange")))
    (blue          (if (eq variant 'dark) (if (true-color-p) "#03a9f4" "DeepSkyBlue2")    (if (true-color-p) "#2196f3" "DeepSkyBlue3")))
    ...
    (magenta       (if (eq variant 'dark) (if (true-color-p) "#ab47bc" "DarkOrchid1")     (if (true-color-p) "#8e24aa" "purple")))
    ...
    (cyan          (if (eq variant 'dark) (if (true-color-p) "#4db6ac" "cyan3")           (if (true-color-p) "#00897b" "DeepSkyBlue4")))
...
;;;;; generic
    ...
    (const         (if (eq variant 'dark) (if (true-color-p) "#ab47bc" "DarkOrchid1")     (if (true-color-p) "#8e24aa" "purple")))
    ...
    (comp          (if (eq variant 'dark) (if (true-color-p) "#ff9800" "DarkOrange")      (if (true-color-p) "#ff5722" "DarkOrange")))
    (err           (if (eq variant 'dark) (if (true-color-p) "#f44336" "red2")            (if (true-color-p) "#d32f2f" "firebrick3")))
    (func          (if (eq variant 'dark) (if (true-color-p) "#4db6ac" "cyan3")           (if (true-color-p) "#0097a7" "cyan4")))
    (head1         (if (eq variant 'dark) (if (true-color-p) "#2db3f8" "DeepSkyBlue1")    (if (true-color-p) "#2376ad" "DodgerBlue4")))
    (head1-bg      (if (eq variant 'dark) (if (true-color-p) "#293239" "gray17")          (if (true-color-p) "#f8f8f2" "gray97")))
    (head2         (if (eq variant 'dark) (if (true-color-p) "#55c1f7" "DeepSkyBlue2")    (if (true-color-p) "#2b6590" "DodgerBlue3")))
    (head2-bg      (if (eq variant 'dark) (if (true-color-p) "#293235" "gray18")          (if (true-color-p) "#f8f8f2" "gray97")))
    (head3         (if (eq variant 'dark) (if (true-color-p) "#7ecef5" "DeepSkyBlue3")    (if (true-color-p) "#2d5475" "DeepSkyBlue3")))
    (head3-bg      (if (eq variant 'dark) (if (true-color-p) "#293235" "gray19")          (if (true-color-p) "#f8f8f2" "gray97")))
    (head4         (if (eq variant 'dark) (if (true-color-p) "#a6dcf4" "DodgerBlue3")     (if (true-color-p) "#2c445b" "DeepSkyBlue2")))
    (head4-bg      (if (eq variant 'dark) (if (true-color-p) "#32322c" "gray20")          (if (true-color-p) "#f8f8f2" "gray97")))
    (head5         (if (eq variant 'dark) (if (true-color-p) "#cee9f2" "DodgerBlue4")     (if (true-color-p) "#293542" "DeepSkyBlue1")))
    ...
    (keyword       (if (eq variant 'dark) (if (true-color-p) "#2196f3" "DeepSkyBlue3")    (if (true-color-p) "#03a9f4" "DeepSkyBlue2")))
    (lnum          (if (eq variant 'dark) (if (true-color-p) "#44505c" "gray29")          (if (true-color-p) "#abb2bf" "gray71")))
    (mat           (if (eq variant 'dark) (if (true-color-p) "#d3e8da" "honeydew2")       (if (true-color-p) "#29422d" "DarkOliveGreen")))
    (meta          (if (eq variant 'dark) (if (true-color-p) "#b5e6ff" "LightSkyBlue1")   (if (true-color-p) "#2d4252" "DodgerBlue4")))
    (str           (if (eq variant 'dark) (if (true-color-p) "#4caf50" "green3")          (if (true-color-p) "#388e3c" "SpringGreen4")))
    (suc           (if (eq variant 'dark) (if (true-color-p) "#0097a7" "cyan4")           (if (true-color-p) "#4db6ac" "cyan3")))
    ...
    (type          (if (eq variant 'dark) (if (true-color-p) "#0ed1d1" "turquoise2")      (if (true-color-p) "#00897b" "DeepSkyBlue4")))
    (var           (if (eq variant 'dark) (if (true-color-p) "#03a9f4" "DeepSkyBlue2")    (if (true-color-p) "#2196f3" "DeepSkyBlue3")))
    (war           (if (eq variant 'dark) (if (true-color-p) "#ffc107" "goldenrod1")      (if (true-color-p) "#ff8f00" "DarkOrange2"))))
...
;;;;; basics
    ...
    `(font-lock-comment-face              ((,class (:foreground ,
                                                    ...
                                                    (if spacemacs-theme-comment-italic 'italic 'normal)))))
...
;;;;; mu4e
    ...
    `(mu4e-cited-4-face ((,class (:foreground ,yellow :background ,bg2))))
    `(mu4e-cited-5-face ((,class (:foreground ,cyan :background ,bg2))))
    `(mu4e-cited-6-face ((,class (:foreground ,orange :background ,bg2))))
    `(mu4e-cited-7-face ((,class (:foreground ,aqua :background ,bg2))))
    `(mu4e-contact-face ((,class (:foreground ,func))))
    `(mu4e-draft-face ((,class (:foreground ,comp))))
    `(mu4e-flagged-face ((,class (:foreground ,str :inherit bold))))
    `(mu4e-forwarded-face ((,class (:foreground ,war))))
    ...
    `(mu4e-replied-face ((,class (:foreground ,type))))
    `(mu4e-modeline-face ((,class (:foreground ,base))))
    `(mu4e-special-header-value-face ((,class (:foreground ,mat))))
    `(mu4e-unread-face ((,class (:foreground ,const :inherit bold))))
