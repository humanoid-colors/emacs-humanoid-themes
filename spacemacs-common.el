...
(defun create-spacemacs-theme (variant theme-name)
  (dyn-let ((class '((class color) (min-colors 89))) ;;              ~~ Dark ~~                              ~~ Light ~~
        ...
        (base          (if (eq variant 'dark) (if (true-color-p) "#f8f8f2" "#ffffff") (if (true-color-p) "#233629" "#5f5f87")))
        ...
        (bg4           (if (eq variant 'dark) (if (true-color-p) "#3b4045" "#080808") (if (true-color-p) "#b3b9be" "#bcbcbc")))
        ...
        (head1         (if (eq variant 'dark) (if (true-color-p) "#11d116" "#268bd2") (if (true-color-p) "#16b1fb" "#268bd2")))
        (head1-bg      (if (eq variant 'dark) (if (true-color-p) "#293239" "#262626") (if (true-color-p) "#f8f8f2" "#ffffff")))
        (head2         (if (eq variant 'dark) (if (true-color-p) "#16b1fb" "#2aa198") (if (true-color-p) "#259b24" "#2aa198")))
        ...
        (highlight     (if (eq variant 'dark) (if (true-color-p) "#49483E" "#444444") (if (true-color-p) "#efeae9" "#d7d7ff")))
        (highlight-dim (if (eq variant 'dark) (if (true-color-p) "#3b4045" "#444444") (if (true-color-p) "#e3dedd" "#d7d7ff")))
        ...
        (str           (if (eq variant 'dark) (if (true-color-p) "#74BDCD" "#2aa198") (if (true-color-p) "#74BDCD" "#2aa198")))
        ...
        (ttip-bg       (if (eq variant 'dark) (if (true-color-p) "#3b4045" "#444444") (if (true-color-p) "#FFFACE" "#dfdfff")))
        (type          (if (eq variant 'dark) (if (true-color-p) "#D47402" "#df005f") (if (true-color-p) "#D47402" "#af005f")))
        (var           (if (eq variant 'dark) (if (true-color-p) "#AE81FF" "#8787d7") (if (true-color-p) "#945AFF" "#af5fd7")))
