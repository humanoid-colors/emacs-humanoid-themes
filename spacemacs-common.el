...
(defun create-spacemacs-theme (variant theme-name)
  (dyn-let ((class '((class color) (min-colors 89))) ;;              ~~ Dark ~~                              ~~ Light ~~
            ;;                                                          GUI       TER                           GUI       TER
            ;; generic
            (act1          (if (eq variant 'dark) (if (true-color-p) "#31363b" "#121212") (if (true-color-p) "#efeae9" "#d7dfff")))
            (act2          (if (eq variant 'dark) (if (true-color-p) "#3b4045" "#444444") (if (true-color-p) "#e3dedd" "#afafd7")))
            (base          (if (eq variant 'dark) (if (true-color-p) "#f8f8f2" "#ffffff") (if (true-color-p) "#232629" "#5f5f87")))
            (base-dim      (if (eq variant 'dark) (if (true-color-p) "#686868" "#585858") (if (true-color-p) "#a49da5" "#afafd7")))
            (bg1           (if (eq variant 'dark) (if (true-color-p) "#232629" "#000000") (if (true-color-p) "#f8f8f2" "#ffffff")))
            (bg2           (if (eq variant 'dark) (if (true-color-p) "#292c30" "#1c1c1c") (if (true-color-p) "#F5F3EF" "#e4e4e4")))
            (bg3           (if (eq variant 'dark) (if (true-color-p) "#31363b" "#121212") (if (true-color-p) "#efeae9" "#d0d0d0")))
            (bg4           (if (eq variant 'dark) (if (true-color-p) "#3b4045" "#080808") (if (true-color-p) "#e7e5eb" "#bcbcbc")))
            (border        (if (eq variant 'dark) (if (true-color-p) "#31363b" "#111111") (if (true-color-p) "#e3dedd" "#b3b9be")))
            (cblk          (if (eq variant 'dark) (if (true-color-p) "#efeae9" "#b2b2b2") (if (true-color-p) "#282C34" "#5f5f87")))
            (cblk-bg       (if (eq variant 'dark) (if (true-color-p) "#282C34" "#262626") (if (true-color-p) "#FFFAFA" "#ffffff")))
            (cblk-ln       (if (eq variant 'dark) (if (true-color-p) "#abb2bf" "#af5faf") (if (true-color-p) "#31363b" "#af5fdf")))
            (cblk-ln-bg    (if (eq variant 'dark) (if (true-color-p) "#292c30" "#333333") (if (true-color-p) "#efeae9" "#dfdfff")))
            (cursor        (if (eq variant 'dark) (if (true-color-p) "#e3dedd" "#d0d0d0") (if (true-color-p) "#100a14" "#121212")))
            (const         (if (eq variant 'dark) (if (true-color-p) "#b77fdb" "#d75fd7") (if (true-color-p) "#8757ad" "#8700af")))
            (comment       (if (eq variant 'dark) (if (true-color-p) "#82865f" "#008787") (if (true-color-p) "#82865f" "#008787")))
            (comment-light (if (eq variant 'dark) (if (true-color-p) "#727553" "#008787") (if (true-color-p) "#94996c" "#008787")))
            (comment-bg    (if (eq variant 'dark) (if (true-color-p) "#232629" "#000000") (if (true-color-p) "#f8f8f2" "#ffffff")))
            (comp          (if (eq variant 'dark) (if (true-color-p) "#00b5e2" "#d75fd7") (if (true-color-p) "#16b1fb" "#8700af")))
            (err           (if (eq variant 'dark) (if (true-color-p) "#d01716" "#d01716") (if (true-color-p) "#f03113" "#d01716")))
            (func          (if (eq variant 'dark) (if (true-color-p) "#f03113" "#d75fd7") (if (true-color-p) "#d01716" "#8700af")))
            (head1         (if (eq variant 'dark) (if (true-color-p) "#77bd5a" "#268bd2") (if (true-color-p) "#42ae2c" "#268bd2")))
            (head1-bg      (if (eq variant 'dark) (if (true-color-p) "#293239" "#262626") (if (true-color-p) "#f8f8f2" "#ffffff")))
            (head2         (if (eq variant 'dark) (if (true-color-p) "#16b1fb" "#2aa198") (if (true-color-p) "#16b1fb" "#2aa198")))
            (head2-bg      (if (eq variant 'dark) (if (true-color-p) "#293235" "#262626") (if (true-color-p) "#f8f8f2" "#ffffff")))
            (head3         (if (eq variant 'dark) (if (true-color-p) "#ff671b" "#67b11d") (if (true-color-p) "#ffa628" "#5faf00")))
            (head3-bg      (if (eq variant 'dark) (if (true-color-p) "#293235" "#262626") (if (true-color-p) "#f8f8f2" "#ffffff")))
            (head4         (if (eq variant 'dark) (if (true-color-p) "#ffa628" "#875f00") (if (true-color-p) "#ff671b" "#875f00")))
            (head4-bg      (if (eq variant 'dark) (if (true-color-p) "#32322c" "#262626") (if (true-color-p) "#f8f8f2" "#ffffff")))
            (highlight     (if (eq variant 'dark) (if (true-color-p) "#49483E" "#444444") (if (true-color-p) "#e3dedd" "#d7d7ff")))
            (highlight-dim (if (eq variant 'dark) (if (true-color-p) "#3b4045" "#444444") (if (true-color-p) "#d6d7d9" "#d7d7ff")))
            (keyword       (if (eq variant 'dark) (if (true-color-p) "#16b1fb" "#268bd2") (if (true-color-p) "#16b1fb" "#268bd2")))
            (lnum          (if (eq variant 'dark) (if (true-color-p) "#44505c" "#444444") (if (true-color-p) "#abb2bf" "#af87af")))
            (mat           (if (eq variant 'dark) (if (true-color-p) "#42ae2c" "#86dc2f") (if (true-color-p) "#77bd5a" "#af005f")))
            (meta          (if (eq variant 'dark) (if (true-color-p) "#ff671b" "#af875f") (if (true-color-p) "#ff671b" "#df5f5f")))
            (str           (if (eq variant 'dark) (if (true-color-p) "#77aadd" "#2aa198") (if (true-color-p) "#0f84ba" "#2aa198")))
            (suc           (if (eq variant 'dark) (if (true-color-p) "#42ae2c" "#86dc2f") (if (true-color-p) "#77bd5a" "#00af00")))
            (ttip          (if (eq variant 'dark) (if (true-color-p) "#75715E" "#888888") (if (true-color-p) "#232629" "#5f5f87")))
            (ttip-sl       (if (eq variant 'dark) (if (true-color-p) "#49483E" "#333333") (if (true-color-p) "#e3dedd" "#afafff")))
            (ttip-bg       (if (eq variant 'dark) (if (true-color-p) "#3b4045" "#444444") (if (true-color-p) "#e7e5eb" "#dfdfff")))
            (type          (if (eq variant 'dark) (if (true-color-p) "#8757ad" "#df005f") (if (true-color-p) "#b77fdb" "#af005f")))
            (var           (if (eq variant 'dark) (if (true-color-p) "#b77fdb" "#8787d7") (if (true-color-p) "#8757ad" "#af5fd7")))
            (war           (if (eq variant 'dark) (if (true-color-p) "#ff671b" "#ff671b") (if (true-color-p) "#ff671b" "#ff671b")))

            ;; colors
            (aqua          (if (eq variant 'dark) (if (true-color-p) "#10DBBC" "#2aa198") (if (true-color-p) "#10DBBC" "#2aa198")))
            (aqua-bg       (if (eq variant 'dark) (if (true-color-p) "#293235" "#262626") (if (true-color-p) "#D3FBF6" "#ffffff")))
            (green         (if (eq variant 'dark) (if (true-color-p) "#77bd5a" "#67b11d") (if (true-color-p) "#42ae2c" "#5faf00")))
            ...
            (cyan          (if (eq variant 'dark) (if (true-color-p) "#00b5e2" "#00ffff") (if (true-color-p) "#00cccc" "#008080")))
            (red           (if (eq variant 'dark) (if (true-color-p) "#eb0028" "#d70000") (if (true-color-p) "#eb0028" "#d70008")))
            ...
            (blue          (if (eq variant 'dark) (if (true-color-p) "#16b1fb" "#268bd2") (if (true-color-p) "#16b1fb" "#268bd2")))
            (blue-bg       (if (eq variant 'dark) (if (true-color-p) "#293239" "#262626") (if (true-color-p) "#edf1fb" "#d7d7ff")))
            (blue-bg-s     (if (eq variant 'dark) (if (true-color-p) "#2d4252" "#262626") (if (true-color-p) "#d1dcfb" "#d7d7ff")))
            (magenta       (if (eq variant 'dark) (if (true-color-p) "#b77fdb" "#af00df") (if (true-color-p) "#b77fdb" "#800080")))
            (yellow        (if (eq variant 'dark) (if (true-color-p) "#ffee66" "#875f00") (if (true-color-p) "#ffa628" "#875f00")))
            (yellow-bg     (if (eq variant 'dark) (if (true-color-p) "#32322c" "#262626") (if (true-color-p) "#f6f1e0" "#ffffff")))
            (orange        (if (eq variant 'dark) (if (true-color-p) "#ff671b" "#ff671b") (if (true-color-p) "#ff671b" "#ff671b")))
            )
           ...
           (custom-theme-set-faces
            ...
            `(link ((,class (:foreground ,comp :underline t))))
            ...
            `(diff-refine-added      ((,class :background ,green-bg-s :foreground ,bg4)))
            `(diff-refine-changed    ((,class :background ,keyword :foreground ,bg4)))
            `(diff-refine-removed    ((,class :background ,red-bg-s :foreground ,bg4)))
            ...
            (when (>= emacs-major-version 26)
              ...
              `(line-number-current-line ((,class (:foreground ,base-dim :background ,bg3)))))
            ...
            `(mu4e-flagged-face ((,class (:foreground ,magenta :inherit bold))))
