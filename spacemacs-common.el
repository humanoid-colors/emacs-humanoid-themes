...
(defun create-spacemacs-theme (variant theme-name)
  (dyn-let ((class '((class color) (min-colors 89))) ;;              ~~ Dark ~~                              ~~ Light ~~
        ...
        (func          (if (eq variant 'dark) (if (true-color-p) "#FA518D" "#d75fd7") (if (true-color-p) "#FA518D" "#8700af")))
        ...
        (str           (if (eq variant 'dark) (if (true-color-p) "#10DBBC" "#2aa198") (if (true-color-p) "#AE81FF" "#2aa198")))
