...
;;;;; mu4e
    ...
    `(mu4e-cited-1-face ((,class (:foreground ,blue :background ,bg2))))
    `(mu4e-cited-2-face ((,class (:foreground ,green :background ,bg2))))
    `(mu4e-cited-3-face ((,class (:foreground ,magenta :background ,bg2))))
    `(mu4e-cited-4-face ((,class (:foreground ,orange :background ,bg2))))
    `(mu4e-cited-5-face ((,class (:foreground ,aqua :background ,bg2))))
    `(mu4e-cited-6-face ((,class (:foreground ,yellow :background ,bg2))))
    `(mu4e-cited-7-face ((,class (:foreground ,cyan :background ,bg2))))
