...
(defun create-humanoid-theme (variant theme-name)
  ...
  (let ((class '((class color) (min-colors 89))) ;;         ~~ Dark ~~                                      ~~ Light ~~
        ...
        (green         (if (eq variant 'dark) (if (true-color-p) "#4caf50" "chartreuse3")     (if (true-color-p) "#388e3c" "SpringGreen4")))
        ...
        (yellow        (if (eq variant 'dark) (if (true-color-p) "#ffc107" "goldenrod1")      (if (true-color-p) "#ffc107" "goldenrod1")))
        (yellow-bg     (if (eq variant 'dark) (if (true-color-p) "#32322c" "wheat4")          (if (true-color-p) "#f6f1e0" "linen")))
        (orange        (if (eq variant 'dark) (if (true-color-p) "#ff9800" "DarkOrange")      (if (true-color-p) "#ff3d00" "OrangeRed")))
        (blue          (if (eq variant 'dark) (if (true-color-p) "#00a6fb" "DeepSkyBlue2")    (if (true-color-p) "#2196f3" "DodgerBlue3")))
        ...
        (magenta       (if (eq variant 'dark) (if (true-color-p) "#ff60ee" "magenta3")        (if (true-color-p) "#5f23a3" "purple3")))
        (purple        (if (eq variant 'dark) (if (true-color-p) "#802edd" "purple2")         (if (true-color-p) "#ff60ee" "magenta2")))
        (aqua          (if (eq variant 'dark) (if (true-color-p) "#0ed1d1" "turquoise2")      (if (true-color-p) "#0097a7" "cyan4")))
        ...
        (gray          (if (eq variant 'dark) (if (true-color-p) "#aaaaa6" "gray64")          (if (true-color-p) "#606870" "gray42")))
        ;; generic
        ...
        (base-dim      (if (eq variant 'dark) (if (true-color-p) "#606870" "gray42")          (if (true-color-p) "#aaaaa6" "gray64")))
        ...
        (builtin       (if (eq variant 'dark) (if (true-color-p) "#00a6fb" "DeepSkyBlue2")    (if (true-color-p) "#2196f3" "DodgerBlue3")))
        ...
        (comp          (if (eq variant 'dark) (if (true-color-p) "#0ed1d1" "cyan3")           (if (true-color-p) "#5f23a3" "purple4")))
        (const         (if (eq variant 'dark) (if (true-color-p) "#ff60ee" "magenta2")        (if (true-color-p) "#880e4f" "DarkRed")))
        ...
        (func          (if (eq variant 'dark) (if (true-color-p) "#c6ff00" "GreenYellow")     (if (true-color-p) "#ff3d00" "OrangeRed")))
        ...
        (keyword       (if (eq variant 'dark) (if (true-color-p) "#72ccf9" "SkyBlue1")        (if (true-color-p) "#0069c0" "RoyalBlue")))
        (lnum          (if (eq variant 'dark) (if (true-color-p) "#5d6658" "SlateGrey")       (if (true-color-p) "#98a890" "SlateGrey")))
        (mat           (if (eq variant 'dark) (if (true-color-p) "#dce775" "yellow1")         (if (true-color-p) "#29422d" "DarkSlateGrey")))
        (meta          (if (eq variant 'dark) (if (true-color-p) "#aaaaa6" "gray71")          (if (true-color-p) "#606870" "gray20")))
        (str           (if (eq variant 'dark) (if (true-color-p) "#7ecb20" "YellowGreen")     (if (true-color-p) "#388e3c" "SpringGreen4")))
        (suc           (if (eq variant 'dark) (if (true-color-p) "#4caf50" "green3")          (if (true-color-p) "#5a9216" "OliveDrab")))
        ...
        (var           (if (eq variant 'dark) (if (true-color-p) "#0487c9" "DeepSkyBlue3")    (if (true-color-p) "#0d47a1" "DeepSkyBlue4")))
        (war           (if (eq variant 'dark) (if (true-color-p) "#ff9800" "DarkOrange")      (if (true-color-p) "#f86d14" "tomato"))))
