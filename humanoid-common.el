...
(defun create-humanoid-theme (variant theme-name)
  ...
  (let ((class '((class color) (min-colors 89))) ;;         ~~ Dark ~~                                      ~~ Light ~~
        ;;                                                     GUI       TER                                   GUI       TER
        ;; colors
        (black         (if (eq variant 'dark) (if (true-color-p) "#070708" "gray4")           (if (true-color-p) "#070708" "gray4")))
        (red           (if (eq variant 'dark) (if (true-color-p) "#f11235" "red2")            (if (true-color-p) "#b0151a" "firebrick3")))
        (red-bg        (if (eq variant 'dark) (if (true-color-p) "#5e1818" "OrangeRed4")      (if (true-color-p) "#ffc9c9" "pink")))
        (red-bg-s      (if (eq variant 'dark) (if (true-color-p) "#490d0d" "DarkRed")         (if (true-color-p) "#ffdddd" "MistyRose")))
        (green         (if (eq variant 'dark) (if (true-color-p) "#02d849" "chartreuse3")     (if (true-color-p) "#388e3c" "SpringGreen4")))
        (green-bg      (if (eq variant 'dark) (if (true-color-p) "#0d5124" "DarkOliveGreen")  (if (true-color-p) "#c8f4c8" "DarkSeaGreen1")))
        (green-bg-s    (if (eq variant 'dark) (if (true-color-p) "#29422d" "DarkGreen")       (if (true-color-p) "#ddffdd" "honeydew2")))
        (yellow        (if (eq variant 'dark) (if (true-color-p) "#ffb627" "goldenrod1")      (if (true-color-p) "#ffb627" "goldenrod1")))
        (yellow-bg     (if (eq variant 'dark) (if (true-color-p) "#32322c" "wheat4")          (if (true-color-p) "#f6f1e0" "linen")))
        (orange        (if (eq variant 'dark) (if (true-color-p) "#ff9505" "DarkOrange")      (if (true-color-p) "#ff3d00" "OrangeRed")))
        (blue          (if (eq variant 'dark) (if (true-color-p) "#00a6fb" "DeepSkyBlue2")    (if (true-color-p) "#0082c9" "DodgerBlue3")))
        (blue-bg       (if (eq variant 'dark) (if (true-color-p) "#445566" "RoyalBlue4")      (if (true-color-p) "#b5e6ff" "LightSkyBlue1")))
        (blue-bg-s     (if (eq variant 'dark) (if (true-color-p) "#2d4252" "DodgerBlue4")     (if (true-color-p) "#ddeeff" "azure2")))
        (magenta       (if (eq variant 'dark) (if (true-color-p) "#df6ee3" "magenta1")        (if (true-color-p) "#630f87" "purple3")))
        (purple        (if (eq variant 'dark) (if (true-color-p) "#811cac" "purple3")         (if (true-color-p) "#ff60ee" "magenta2")))
        (aqua          (if (eq variant 'dark) (if (true-color-p) "#0ed1d1" "turquoise2")      (if (true-color-p) "#008e8e" "cyan4")))
        (aqua-bg       (if (eq variant 'dark) (if (true-color-p) "#061413" "DarkSlateGrey")   (if (true-color-p) "#ebf9f9" "azure1")))
        (cyan          (if (eq variant 'dark) (if (true-color-p) "#1de9b6" "aquamarine2")     (if (true-color-p) "#00bfa5" "aquamarine3")))
        (white         (if (eq variant 'dark) (if (true-color-p) "#fcfcfc" "grey99")          (if (true-color-p) "#fcfcfc" "gray99")))
        (gray          (if (eq variant 'dark) (if (true-color-p) "#c0c0bd" "gray64")          (if (true-color-p) "#60615d" "gray42")))
        ;; generic
        (act1          (if (eq variant 'dark) (if (true-color-p) "#3b4045" "gray28")          (if (true-color-p) "#e8e8e2" "gray89")))
        (act2          (if (eq variant 'dark) (if (true-color-p) "#484e54" "gray32")          (if (true-color-p) "#deded8" "gray83")))
        (base          (if (eq variant 'dark) (if (true-color-p) "#f8f8f2" "gray97")          (if (true-color-p) "#232629" "gray18")))
        (base-dim      (if (eq variant 'dark) (if (true-color-p) "#60615d" "gray42")          (if (true-color-p) "#c0c0bd" "gray64")))
        (bg0           (if (eq variant 'dark) (if (true-color-p) "#151718" "gray12")          (if (true-color-p) "#fcfcfc" "gray99")))
        (bg1           (if (eq variant 'dark) (if (true-color-p) "#232629" "gray18")          (if (true-color-p) "#f8f8f2" "gray96")))
        (bg2           (if (eq variant 'dark) (if (true-color-p) "#2f3337" "gray22")          (if (true-color-p) "#f4f4ee" "gray93")))
        (bg3           (if (eq variant 'dark) (if (true-color-p) "#3b4045" "gray28")          (if (true-color-p) "#efefe9" "gray90")))
        (bg4           (if (eq variant 'dark) (if (true-color-p) "#484e54" "gray32")          (if (true-color-p) "#e8e8e2" "gray87")))
        (builtin       (if (eq variant 'dark) (if (true-color-p) "#72ccf9" "LightSkyBlue")    (if (true-color-p) "#2196f3" "DodgerBlue3")))
        (border        (if (eq variant 'dark) (if (true-color-p) "#31363b" "gray20")          (if (true-color-p) "#deded8" "gray83")))
        (cblk          (if (eq variant 'dark) (if (true-color-p) "#f4f4ee" "gray93")          (if (true-color-p) "#2f3337" "gray22")))
        (cblk-bg       (if (eq variant 'dark) (if (true-color-p) "#151718" "gray12")          (if (true-color-p) "#fcfcf6" "gray98")))
        (cblk-ln       (if (eq variant 'dark) (if (true-color-p) "#5d6658" "cornsilk4")       (if (true-color-p) "#98a890" "cornsilk4")))
        (cblk-ln-bg    (if (eq variant 'dark) (if (true-color-p) "#2f3337" "gray22")          (if (true-color-p) "#efefe9" "gray90")))
        (comment       (if (eq variant 'dark) (if (true-color-p) "#6b7566" "LemonChiffon4")   (if (true-color-p) "#8b9985" "LemonChiffon4")))
        (comment-bg    (if (eq variant 'dark) (if (true-color-p) "#232629" "gray18")          (if (true-color-p) "#f8f8f2" "gray96")))
        (comment-light (if (eq variant 'dark) (if (true-color-p) "#75715e" "LightGoldenrod4") (if (true-color-p) "#6b7566" "LightYellow4")))
        (comp          (if (eq variant 'dark) (if (true-color-p) "#7ecb20" "YellowGreen")     (if (true-color-p) "#5f23a3" "purple4")))
        (const         (if (eq variant 'dark) (if (true-color-p) "#df6ee3" "magenta1")        (if (true-color-p) "#880e4f" "DarkRed")))
        (cursor        (if (eq variant 'dark) (if (true-color-p) "#64dd17" "chartreuse2")     (if (true-color-p) "#64dd17" "chartreuse2")))
        (err           (if (eq variant 'dark) (if (true-color-p) "#f11235" "red2")            (if (true-color-p) "#b0151a" "firebrick3")))
        (func          (if (eq variant 'dark) (if (true-color-p) "#0ed1d1" "cyan3")           (if (true-color-p) "#ff3d00" "OrangeRed")))
        (head1         (if (eq variant 'dark) (if (true-color-p) "#42a5f5" "DeepSkyBlue1")    (if (true-color-p) "#2376ad" "DodgerBlue3")))
        (head1-bg      (if (eq variant 'dark) (if (true-color-p) "#293239" "gray17")          (if (true-color-p) "#efefe9" "gray97")))
        (head2         (if (eq variant 'dark) (if (true-color-p) "#29b6f6" "DeepSkyBlue2")    (if (true-color-p) "#2b6590" "DodgerBlue4")))
        (head2-bg      (if (eq variant 'dark) (if (true-color-p) "#293235" "gray18")          (if (true-color-p) "#efefe9" "gray97")))
        (head3         (if (eq variant 'dark) (if (true-color-p) "#26c6da" "cyan3")           (if (true-color-p) "#2d5475" "RoyalBlue4")))
        (head3-bg      (if (eq variant 'dark) (if (true-color-p) "#293235" "gray19")          (if (true-color-p) "#efefe9" "gray97")))
        (head4         (if (eq variant 'dark) (if (true-color-p) "#26a69a" "LightSeaGreen")   (if (true-color-p) "#2c445b" "SlateBlue4")))
        (head4-bg      (if (eq variant 'dark) (if (true-color-p) "#32322c" "gray20")          (if (true-color-p) "#efefe9" "gray97")))
        (head5         (if (eq variant 'dark) (if (true-color-p) "#66bb6a" "PaleGreen3")      (if (true-color-p) "#293542" "DarkSlateBlue")))
        (head5-bg      (if (eq variant 'dark) (if (true-color-p) "#32322c" "gray26")          (if (true-color-p) "#efefe9" "gray97")))
        (highlight     (if (eq variant 'dark) (if (true-color-p) "#484e54" "gray30")          (if (true-color-p) "#e8e8e2" "gray89")))
        (highlight-dim (if (eq variant 'dark) (if (true-color-p) "#545b62" "gray36")          (if (true-color-p) "#deded8" "gray85")))
        (keyword       (if (eq variant 'dark) (if (true-color-p) "#00a6fb" "DeepSkyBlue2")    (if (true-color-p) "#0069c0" "RoyalBlue")))
        (lnum          (if (eq variant 'dark) (if (true-color-p) "#5d6658" "SlateGrey")       (if (true-color-p) "#98a890" "SlateGrey")))
        (mat           (if (eq variant 'dark) (if (true-color-p) "#ffb627" "goldenrod1")      (if (true-color-p) "#29422d" "DarkSlateGrey")))
        (meta          (if (eq variant 'dark) (if (true-color-p) "#c0c0bd" "gray71")          (if (true-color-p) "#60615d" "gray20")))
        (str           (if (eq variant 'dark) (if (true-color-p) "#02d849" "green3")          (if (true-color-p) "#388e3c" "SpringGreen4")))
        (suc           (if (eq variant 'dark) (if (true-color-p) "#20bf55" "green4")          (if (true-color-p) "#5a9216" "OliveDrab")))
        (ttip          (if (eq variant 'dark) (if (true-color-p) "#75715e" "wheat4")          (if (true-color-p) "#232629" "gray15")))
        (ttip-bg       (if (eq variant 'dark) (if (true-color-p) "#484e54" "gray25")          (if (true-color-p) "#e8e8e2" "gray88")))
        (ttip-sl       (if (eq variant 'dark) (if (true-color-p) "#545b62" "gray28")          (if (true-color-p) "#deded8" "gray84")))
        (type          (if (eq variant 'dark) (if (true-color-p) "#0097a7" "cyan4")           (if (true-color-p) "#007c91" "cyan4")))
        (var           (if (eq variant 'dark) (if (true-color-p) "#c6ff00" "GreenYellow")     (if (true-color-p) "#0d47a1" "DeepSkyBlue4")))
        (war           (if (eq variant 'dark) (if (true-color-p) "#ff9505" "DarkOrange")      (if (true-color-p) "#ff3d00" "OrangeRed"))))
