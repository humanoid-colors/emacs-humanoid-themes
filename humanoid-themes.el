...
(defun humanoid-create (variant theme-name)
  ...
  (let ((class '((class color) (min-colors 89))) ;;                        ~~ Dark ~~                                            ~~ Light ~~
        ...
        (red-fg        (if (eq variant 'dark) (if (humanoid-true-color) "#ffe0e1" "MistyRose")       (if (humanoid-true-color) "#461218" "DarkRed")))
        (red-bg-b      (if (eq variant 'dark) (if (humanoid-true-color) "#83212d" "OrangeRed4")      (if (humanoid-true-color) "#ff8a8c" "pink")))
        (red-bg        (if (eq variant 'dark) (if (humanoid-true-color) "#5a171f" "OrangeRed4")      (if (humanoid-true-color) "#ffbdbe" "pink")))
        (red-bg-s      (if (eq variant 'dark) (if (humanoid-true-color) "#461218" "DarkRed")         (if (humanoid-true-color) "#ffd7d7" "MistyRose")))
        ...
        (green-bg-b    (if (eq variant 'dark) (if (humanoid-true-color) "#1c7725" "DarkOliveGreen")  (if (humanoid-true-color) "#8aca83" "DarkSeaGreen1")))
        (green-bg      (if (eq variant 'dark) (if (humanoid-true-color) "#124e18" "DarkOliveGreen")  (if (humanoid-true-color) "#bde1b9" "DarkSeaGreen1")))
        (green-bg-s    (if (eq variant 'dark) (if (humanoid-true-color) "#0d3912" "DarkGreen")       (if (humanoid-true-color) "#cee9cb" "honeydew2")))
        ...
        (brown-fg      (if (eq variant 'dark) (if (humanoid-true-color) "#fceac3" "gray42")          (if (humanoid-true-color) "#46381d" "gray64")))
        (brown-bg-b    (if (eq variant 'dark) (if (humanoid-true-color) "#7c6433" "gray64")          (if (humanoid-true-color) "#d7b87f" "gray42")))
        (brown-bg      (if (eq variant 'dark) (if (humanoid-true-color) "#584724" "gray64")          (if (humanoid-true-color) "#e9d8b9" "gray42")))
        (brown-bg-s    (if (eq variant 'dark) (if (humanoid-true-color) "#46381d" "gray64")          (if (humanoid-true-color) "#efe3cc" "gray42")))
