...
(defun humanoid-create (variant theme-name)
  ...
  (let ((class '((class color) (min-colors 89))) ;;                        ~~ Dark ~~                                            ~~ Light ~~
        ...
        (green-dark    (if (eq variant 'dark) (if (humanoid-true-color) "#22a54e" "green4")          (if (humanoid-true-color) "#096b38" "DarkOliveGreen")))
        ...
        (blue-dark     (if (eq variant 'dark) (if (humanoid-true-color) "#006fd7" "DodgerBlue3")     (if (humanoid-true-color) "#117396" "DodgerBlue3")))
        ...
        (bg2           (if (eq variant 'dark) (if (humanoid-true-color) "#393f4c" "gray22")          (if (humanoid-true-color) "#f4f4ee" "gray93")))
        ...
        (highlight     (if (eq variant 'dark) (if (humanoid-true-color) "#393f4c" "gray30")          (if (humanoid-true-color) "#b1bfbb" "gray89")))
        (highlight-dim (if (eq variant 'dark) (if (humanoid-true-color) "#383C4A" "gray36")          (if (humanoid-true-color) "#e9f0e5" "gray85")))
        ...
        (str           (if (eq variant 'dark) (if (humanoid-true-color) "#60e2e4" "turquoise1")      (if (humanoid-true-color) "#006873" "DarkSlateGray")))
    ...
    (custom-theme-set-faces
     ...
     `(diredfl-exec-priv ((,class (:background ,green-bg))))
     ...
     `(diredfl-rare-priv ((,class (:background ,red-bg-b))))
     `(diredfl-read-priv ((,class (:background ,red-bg))))
     ...
     `(helm-source-header               ((,class (:background ,bg2 :foreground ,cblk :inherit bold))))
     ...
     `(notmuch-search-unread-face    ((,class (:background ,bg0 :inherit bold :underline t))))
     ...
     `(org-done                      ((,class (:foreground ,suc :inherit bold :background ,green-bg-s))))
