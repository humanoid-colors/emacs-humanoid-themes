...
(defun humanoid-create (variant theme-name)
  ...
  (let ((class '((class color) (min-colors 89))) ;;                        ~~ Dark ~~                                            ~~ Light ~~
        ...
        (red-light     (if (eq variant 'dark) (if (humanoid-true-color) "#f53b61" "red2")            (if (humanoid-true-color) "#e02e41" "firebrick3")))
        (red           (if (eq variant 'dark) (if (humanoid-true-color) "#f11235" "red2")            (if (humanoid-true-color) "#b0151a" "firebrick3")))
        (red-dark      (if (eq variant 'dark) (if (humanoid-true-color) "#bd192d" "red2")            (if (humanoid-true-color) "#911609" "firebrick3")))
        ...
        (green-light   (if (eq variant 'dark) (if (humanoid-true-color) "#55fa68" "chartreuse3")     (if (humanoid-true-color) "#53ac34" "SpringGreen4")))
        (green         (if (eq variant 'dark) (if (humanoid-true-color) "#02d849" "chartreuse3")     (if (humanoid-true-color) "#388e3c" "SpringGreen4")))
        (green-dark    (if (eq variant 'dark) (if (humanoid-true-color) "#1db45d" "chartreuse3")     (if (humanoid-true-color) "#3f7c4b" "SpringGreen4")))
        ...
        (orange-light  (if (eq variant 'dark) (if (humanoid-true-color) "#fea608" "DarkOrange")      (if (humanoid-true-color) "#fb5f30" "OrangeRed")))
        (orange        (if (eq variant 'dark) (if (humanoid-true-color) "#ff9505" "DarkOrange")      (if (humanoid-true-color) "#ff3d00" "OrangeRed")))
        (orange-dark   (if (eq variant 'dark) (if (humanoid-true-color) "#ff7805" "DarkOrange")      (if (humanoid-true-color) "#e42f2c" "OrangeRed")))
        (blue-light    (if (eq variant 'dark) (if (humanoid-true-color) "#26c9fe" "DeepSkyBlue2")    (if (humanoid-true-color) "#0b9ae9" "DodgerBlue3")))
        (blue          (if (eq variant 'dark) (if (humanoid-true-color) "#00a6fb" "DeepSkyBlue2")    (if (humanoid-true-color) "#0082c9" "DodgerBlue3")))
        (blue-dark     (if (eq variant 'dark) (if (humanoid-true-color) "#1492ee" "DeepSkyBlue2")    (if (humanoid-true-color) "#116dc0" "DodgerBlue3")))
        ...
        (magenta-light (if (eq variant 'dark) (if (humanoid-true-color) "#f970f1" "magenta2")        (if (humanoid-true-color) "#a622bf" "purple3")))
        (magenta       (if (eq variant 'dark) (if (humanoid-true-color) "#ff60ee" "magenta2")        (if (humanoid-true-color) "#700f98" "purple3")))
        (magenta-dark  (if (eq variant 'dark) (if (humanoid-true-color) "#e52dd4" "magenta2")        (if (humanoid-true-color) "#520b70" "purple3")))
        (purple-light  (if (eq variant 'dark) (if (humanoid-true-color) "#b257fd" "purple2")         (if (humanoid-true-color) "#5d24e6" "magenta2")))
        (purple        (if (eq variant 'dark) (if (humanoid-true-color) "#984aff" "purple2")         (if (humanoid-true-color) "#4d10a5" "magenta2")))
        (purple-dark   (if (eq variant 'dark) (if (humanoid-true-color) "#7f46f8" "purple2")         (if (humanoid-true-color) "#3e1295" "magenta2")))
        (aqua-light    (if (eq variant 'dark) (if (humanoid-true-color) "#34f0f6" "turquoise2")      (if (humanoid-true-color) "#14b9b6" "cyan4")))
        (aqua          (if (eq variant 'dark) (if (humanoid-true-color) "#0ed1d1" "turquoise2")      (if (humanoid-true-color) "#008e8e" "cyan4")))
        (aqua-dark     (if (eq variant 'dark) (if (humanoid-true-color) "#19b9d0" "turquoise2")      (if (humanoid-true-color) "#137e94" "cyan4")))
        ...
        (base          (if (eq variant 'dark) (if (humanoid-true-color) "#f8f8f2" "gray97")          (if (humanoid-true-color) "#232629" "gray18")))
        ...
        (bg1           (if (eq variant 'dark) (if (humanoid-true-color) "#232629" "gray18")          (if (humanoid-true-color) "#f8f8f2" "gray96")))
        ...
        (builtin       (if (eq variant 'dark) (if (humanoid-true-color) "#72ccf9" "LightSkyBlue")    (if (humanoid-true-color) "#2196f3" "DodgerBlue3")))
        ...
        (const         (if (eq variant 'dark) (if (humanoid-true-color) "#ff60ee" "magenta1")        (if (humanoid-true-color) "#880e4f" "DarkRed")))
...
;;;;; basics
     ...
     `(isearch                             ((,class (:foreground ,act1 :background ,suc))))
